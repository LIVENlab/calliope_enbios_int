...
# pniec data / Calliope (without background changes)
run(materials=[],
    ccs_clinker=False, train_electrification=False, biomass_from_residues=False, h2_iron_and_steel=False,
    ...
    mapping_file_path=r'C:\Users\1361185\OneDrive - UAB\Documentos\GitHub\calliope_enbios_int\data\input\tech_mapping_in.xlsx',
    file_out_path=r'C:\Users\1361185\OneDrive - UAB\Documentos\GitHub\calliope_enbios_int\data\output\tech_mapping_out_v1.xlsx'
    )

# TODO: change WindTrace onshore to new version

# Calliope (with background changes)
#run(ccs_clinker=True, train_electrification=True, biomass_from_residues=True, h2_iron_and_steel=True,
#    olefins_from_methanol=True, methanol_from_electrolysis=True, ammonia_from_hydrogen=True,
#    trucks_electrification=True, sea_transport_syn_diesel=True,
#
#    ccs=False, vehicles_as_batteries=False,
#    # current data (2023). World. Source: https://www.iea.org/energy-system/low-emission-fuels/electrolysers
#    soec_electrolyser_share=0.18, aec_electrolyser_share=0.6, pem_electrolyser_share=0.22,
...
#   mapping_file_path=r'C:\Users\1361185\OneDrive - UAB\Documentos\GitHub\calliope_enbios_int\data_calliope\input\tech_mapping_spain.xlsx',
#    file_out_path=r'C:\Users\1361185\OneDrive - UAB\Documentos\GitHub\calliope_enbios_int\data_calliope\output\tech_mapping_out.xlsx'
#    )
